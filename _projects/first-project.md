...
Most health platforms use similar signals for recovery, readiness, and fatigue. I wanted to build a transparent system where I could inspect those signals directly, define my own thresholds, and connect trends to training decisions.

This project focuses on turning raw wearable data into practical feedback:
- daily recovery trend signals
- stress and load markers
- sleep and readiness context
- warning flags when rest debt accumulates

The operating goal is prevention. If stress is rising and recovery is declining across multiple days, the dashboard should help me adjust effort before performance drops or injury risk rises.
